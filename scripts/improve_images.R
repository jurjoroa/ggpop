# *****************************************************************************
#
# Script: improve_images.R
#
# Purpose: Example for improve image quality in a ggplot2 plot
#
# Author: Jorge Roa
#
...
ggplot(df_coor_dots, aes(x=x1, y=y1,  color=type)) +
  geom_image(aes(image = ifelse(type == "OTHER", "fffff.svg", "fffff.svg")), 
             size = 0.03)


ggsave("example_plot_quality7.png", width = 10, height = 10, dpi = 600)
