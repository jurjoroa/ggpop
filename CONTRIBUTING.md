...
This outlines how to propose a change to ggpop. For more detailed info
...
Conduct](https://jurjoroa.github.io/ggpop/CODE_OF_CONDUCT.md). By
participating in this project you agree to abide by its terms.

## Additional Resources

See the tidyverse [development contributing
guide](https://rstd.io/tidy-contrib) for further details.

------------------------------------------------------------------------

**Note:** This contributing guide is adapted from the [dplyr
package](https://github.com/tidyverse/dplyr) contributing guidelines. We
follow similar practices to maintain consistency with the tidyverse
ecosystem.
