...
ggplot(df_health, aes(x = spend, y = life_exp,
  ...
  theme(
    plot.background   = element_blank(),
    panel.grid.major = element_line(color = "#546E7A", size = 0.5),
    panel.grid.minor = element_line(color = "#455A64", size = 0.25),
    legend.background = element_blank(),
    legend.key        = element_blank(),
    legend.text = element_text(color = "white", size = 9),
...
#| label: ggforce
#| echo: false
#| eval: !expr requireNamespace("ggforce", quietly = TRUE)
#| message: false
#| warning: false
#| fig-width: 11
#| fig-height: 7
