---
title: "Animated Markov Cohort (Sick-Sicker)"
format:
  html:
    code-fold: true
    code-summary: "Show the code"
vignette: >
  %\VignetteIndexEntry{Animated Markov Cohort (Sick-Sicker)}
  %\VignetteEngine{quarto::html}
  %\VignetteEncoding{UTF-8}
---

This example shows how to combine a cohort Markov model with `ggpop` and `gganimate`.
