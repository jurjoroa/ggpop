...
food_data$group <- factor(food_data$group,
  levels = c("Fruit & Veg", "Dairy", "Meat & Fish"))

ggplot(food_data, aes(x = calories, y = protein, icon = icon, color = group)) +
...
ggplot(health_data, aes(x = spend, y = life_exp,
