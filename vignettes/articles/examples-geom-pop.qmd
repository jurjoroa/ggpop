...
Use bundled geometric markers instead of Font Awesome icons — perfect when no suitable FA icon exists. Each energy source gets its own shape and colour; no `fa_icons()` search needed.

```{r}
#| label: bundled-markers-pop-show
#| eval: false
