...
testthat::test_that("uses parameter when no size in mapping", {
...
testthat::test_that("uses mapped size column", {
...
testthat::test_that("inherits size from ggplot", {
  combined_mapping <- list(size = rlang::sym("size_col"))
  mapping_list <- list()
...
testthat::test_that("detects colour aesthetic", {
...
testthat::test_that("detects color aesthetic (US spelling)", {
...
testthat::test_that("detects group aesthetic", {
...
testthat::test_that("falls back to icon if multiple icons", {
  combined_mapping <- list()
...
testthat::test_that("returns NULL when no legend needed", {
...
testthat::test_that("creates mapping for legend variable", {
  legend_var <- "category"
...
testthat::test_that("picks most common icon per group", {
  df_multi <- data.frame(
...
testthat::test_that("uses first icon when no legend_var", {
  icon_by_legend <- ggpop:::create_icon_by_legend(
    data = df_test,
    legend_var = NULL,
    icon = NULL,
...
testthat::test_that("uses icon parameter when provided", {
  icon_by_legend <- ggpop:::create_icon_by_legend(
    data = df_test,
    legend_var = NULL,
    icon = "star",
...
testthat::test_that("renames icon column", {
...
testthat::test_that("keeps icon column if already named icon", {
...
testthat::test_that("handles NULL icon_var", {
...
testthat::test_that("adds icon if not present", {
  mapping_list <- list()
...
testthat::test_that("preserves existing icon mapping", {
...
testthat::test_that("swaps data and mapping when reversed", {
...
testthat::test_that("keeps correct order unchanged", {
...
testthat::test_that("handles NULL mapping", {
  result <- ggpop:::handle_argument_swap(
    mapping = NULL,
    data = df_test
  )
...
testthat::test_that("assigns sequential positions without facet", {
...
testthat::test_that("assigns positions per facet group", {
...
testthat::test_that("preserves order when arrange=TRUE", {
...
testthat::test_that("shuffles when arrange=FALSE", {
  set.seed(123)
...
testthat::test_that("shuffles within facet groups", {
  df_faceted <- data.frame(
    x = 1:6,
    icon = rep("circle", 6),
